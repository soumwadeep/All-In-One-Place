...
function myfunc() {
  ...
  // Checking if Congratulations Player X ! You Have Won This Game !! or not and after
  ...
  if (
    ...
    window.alert("Congratulations Player X ! You Have Won This Game !!");
  } else if (
    (b1 == "x" || b1 == "X") &&
    (b4 == "x" || b4 == "X") &&
    (b7 == "x" || b7 == "X")
  ...
  // Checking for Player O starts, Is Congratulations Player O ! You Have Won This Game !! or
  // not and after that disabled all the other fields
    ...
    document.getElementById("b8").disabled = true;
    document.getElementById("b9").disabled = true;
    window.alert("Congratulations Player O ! You Have Won This Game !!");
  } else if (
    (b1 == "0" || b1 == "0") &&
    (b4 == "0" || b4 == "0") &&
    (b7 == "0" || b7 == "0")
